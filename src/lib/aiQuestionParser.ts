...
export interface GeneratePromptParams {
  ...
  cognitiveCustomLevels?: Array<'c1' | 'c2' | 'c3' | 'c4' | 'c5' | 'c6'>; // aktif jika cognitiveFocus === 'custom'
  cognitiveProportions?: Partial<Record<'c1' | 'c2' | 'c3' | 'c4' | 'c5' | 'c6', number>>; // % per level, hanya jika custom
...
- Padukan antara pengujian pemahaman konsep inti materi dengan soal bernalar berbasis stimulus yang menantang rasa ingin tahu siswa.`;
    ...
    // 'auto' — AI memilih distribusi kognitif terbaik berdasarkan fase, jenjang, dan topik
...
- Tautkan materi pelajaran dengan situasi nyata yang masuk akal dan relevan bagi peserta didik.`;
    ...
    // 'auto' — AI memilih tema terbaik sesuai topik dan jenjang
