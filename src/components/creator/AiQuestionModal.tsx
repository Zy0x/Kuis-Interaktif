      ...
      <div className="bg-white dark:bg-slate-900 w-full max-w-3xl 2xl:max-w-4xl max-h-[92vh] rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl flex flex-col overflow-hidden">
        ...
        {notification && (
          <div className="bg-emerald-50 dark:bg-emerald-950/80 border-b border-emerald-200 dark:border-emerald-800/60 px-5 py-2.5 text-xs font-bold text-emerald-800 dark:text-emerald-200 flex items-center justify-between animate-fade-in flex-shrink-0">
            ...
            <button
              ...
              className="text-emerald-700 hover:text-emerald-900 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg transition-colors"
        ...
        <div className="px-5 pt-3 pb-2 flex gap-2 border-b border-slate-100 dark:border-slate-800 flex-shrink-0 bg-white dark:bg-slate-900">
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-bold flex items-center gap-1.5 transition-all min-h-[44px] ${
              activeTab === 'generate'
                ...
                <div className="flex flex-wrap gap-1.5">
                  {TOPIC_SUGGESTIONS.map((st) => (
                    <button
                      ...
                      className="px-3 py-2 rounded-xl text-xs font-medium bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:text-blue-600 transition-colors border border-slate-200/80 dark:border-slate-700 min-h-[44px] inline-flex items-center"
                    >
                      + {st}
                    </button>
                  ))}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white font-semibold text-xs sm:text-sm min-h-[44px]"
                  >
                  ...
                  <div className="grid grid-cols-3 gap-1.5 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl">
                    {[3, 5, 10].map((cnt) => (
                      <button
                        ...
                        className={`py-2 rounded-lg text-xs font-bold transition-all min-h-[44px] flex items-center justify-center ${
                          count === cnt
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5 bg-slate-100 dark:bg-slate-800 p-1.5 rounded-xl">
                  {[
                    ...
                    <button
                      ...
                      className={`py-2 px-2.5 rounded-lg text-xs font-bold transition-all min-h-[44px] flex items-center justify-center text-center ${
                        questionType === t.id
                          ? 'bg-white dark:bg-slate-700 text-blue-600 dark:text-blue-400 shadow-sm'
              ...
              <div className="bg-slate-50 dark:bg-slate-800/60 rounded-2xl p-3.5 border border-slate-200 dark:border-slate-700/80 space-y-3">
                <div className="flex items-center justify-between gap-2 flex-wrap">
                  ...
                  <button
                    ...
                    className="text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 flex items-center gap-1.5 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 transition-all min-h-[44px]"
                  >
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                        <button
                          ...
                          className={`p-2.5 rounded-xl border text-xs font-bold flex items-center justify-center gap-1.5 transition-all min-h-[44px] ${
                            activeProvider === 'deepseek'
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="text-[11px] font-semibold text-sky-600 dark:text-sky-400 hover:underline flex items-center gap-1 min-h-[44px]"
                            >
                          ...
                          <div className="relative">
                            <input
                              ...
                              className="w-full pl-3 pr-12 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white font-mono text-xs focus:outline-none focus:border-sky-500 min-h-[44px]"
                            />
                            <button
                              type="button"
                              ...
                              aria-label={showKeyText ? "Sembunyikan Kunci" : "Tampilkan Kunci"}
                            >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          <div>
                            ...
                            <select
                              ...
                              className="w-full px-3 py-2 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 text-xs font-semibold focus:outline-none min-h-[44px]"
                            >
                          ...
                          <div className="flex items-end gap-2">
                            <button
                              ...
                              className="flex-1 bg-sky-600 hover:bg-sky-700 text-white font-bold text-xs py-2 px-3 rounded-xl flex items-center justify-center gap-1.5 min-h-[44px] transition-all"
                            >
                            ...
                            {hasDeepSeekApiKey() && (
                              <button
                                ...
                                className="text-xs font-bold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 py-2 px-3 rounded-xl border border-rose-200 dark:border-rose-900/60 min-h-[44px] transition-all flex items-center justify-center"
                              >
                                Hapus
                              </button>
                            )}
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="text-[11px] font-semibold text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1 min-h-[44px]"
                            >
                          ...
                          <div className="relative">
                            <input
                              ...
                              className="w-full pl-3 pr-12 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white font-mono text-xs focus:outline-none focus:border-blue-500 min-h-[44px]"
                            />
                            <button
                              type="button"
                              onClick={() => setShowKeyText(!showKeyText)}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          ...
                          <div className="flex items-end gap-2">
                            <button
                              type="button"
                              onClick={handleSaveApiSettings}
                              className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs py-2 px-3 rounded-xl flex items-center justify-center gap-1.5 min-h-[44px] transition-all"
                            >
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="text-[11px] font-semibold text-amber-600 dark:text-amber-400 hover:underline flex items-center gap-1 min-h-[44px]"
                            >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          ...
                          <div className="flex items-end gap-2">
                            <button
                              type="button"
                              onClick={handleSaveApiSettings}
                              className="flex-1 bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs py-2 px-3 rounded-xl flex items-center justify-center gap-1.5 min-h-[44px] transition-all"
                            >
            ...
            <div className="space-y-3 animate-fade-in">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-xs font-bold text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1.5 min-h-[44px] px-2.5 py-1.5 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-950/40 transition-colors"
                >
