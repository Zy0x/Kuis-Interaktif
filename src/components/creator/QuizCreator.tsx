          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 max-w-sm w-full border border-slate-200 dark:border-slate-800 shadow-2xl space-y-4">
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
              <button
                ...
                className="px-4 py-2.5 rounded-xl text-xs font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors min-h-[44px] btn-press"
              >
                Batal
              </button>
              <button
                ...
                className="px-4 py-2.5 rounded-xl text-xs font-bold text-white bg-rose-600 hover:bg-rose-700 transition-colors min-h-[44px] btn-press shadow-xs"
              >
                Ya, Kosongkan
              </button>
            </div>
                      ...
                      {q.explanation && (
                        <div className="mt-2.5 pt-2 border-t border-slate-100 dark:border-slate-800">
                          <button
                            ...
                            className="text-[11px] font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 flex items-center gap-1.5 py-2 px-3 rounded-lg bg-blue-50/60 dark:bg-blue-950/40 hover:bg-blue-100/60 dark:hover:bg-blue-900/50 transition-colors min-h-[44px]"
                          >
                  ...
                  <div className="flex items-start gap-3">
                    <div className="relative group w-20 h-20 sm:w-24 sm:h-24 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shrink-0 flex items-center justify-center shadow-xs">
                      ...
                      <button
                        ...
                        className="absolute inset-0 w-full h-full min-h-[44px] bg-black/60 text-white text-[11px] font-bold opacity-0 group-hover:opacity-100 focus:opacity-100 active:opacity-100 flex items-center justify-center transition-opacity"
                    ...
                    <div className="space-y-1.5">
                      <div className="space-y-0.5">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <div className="inline-flex p-0.5 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs font-bold shrink-0">
                            <button
                              type="button"
