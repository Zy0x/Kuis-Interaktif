          ...
          <div className="flex items-center gap-1.5 shrink-0">
            {isCurrentAnImage && (
              <button
                ...
                className="px-3 py-2 rounded-xl bg-white dark:bg-slate-800 hover:bg-rose-50 dark:hover:bg-rose-950/40 text-rose-600 dark:text-rose-400 border border-slate-200 dark:border-slate-700 text-xs font-bold transition-colors shrink-0 flex items-center gap-1.5 btn-press min-h-[44px]"
              ...
              <div className="flex items-center gap-1.5 overflow-x-auto pb-1.5 scrollbar-none touch-pan-x">
                {COVER_EMOJI_CATEGORIES.map((cat) => (
                  <button
                    ...
                    className={`px-3.5 py-2 rounded-xl text-xs font-bold shrink-0 transition-all min-h-[44px] flex items-center justify-center ${
